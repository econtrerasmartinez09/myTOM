...
<head>
    ...
    <title>Coverage for /home/ezequiel/atlas_query/lib/python3.11/site-packages/tom_alerts/apps.py: 75%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/ezequiel/atlas_query/lib/python3.11/site-packages/tom_alerts/apps.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="key">class</span> <span class="nam">TomAlertsConfig</span><span class="op">(</span><span class="nam">AppConfig</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t5" class="run"><span class="n"><a href="#t5">5</a></span><span class="t">    <span class="nam">name</span> <span class="op">=</span> <span class="str">'tom_alerts'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
