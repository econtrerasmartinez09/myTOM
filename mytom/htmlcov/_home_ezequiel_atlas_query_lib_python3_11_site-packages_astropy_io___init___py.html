...
<head>
    ...
    <title>Coverage for /home/ezequiel/atlas_query/lib/python3.11/site-packages/astropy/io/__init__.py: 50%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/ezequiel/atlas_query/lib/python3.11/site-packages/astropy/io/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t3" class="pln"><span class="n"><a href="#t3">3</a></span><span class="t"><span class="str">This subpackage contains modules and packages for interpreting data storage</span>&nbsp;</span><span class="r"></span></p>
    <p id="t4" class="pln"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="str">formats used by and in astropy.</span>&nbsp;</span><span class="r"></span></p>
